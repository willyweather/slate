...
Returns the account associated by the billing id.
...
Parameter | Type | Options | Description | Required
--------- | ---- | ------- | ----------- | --------
billingId | string | | Subscription identifier for premium subscription (if provided the registered account will have a premium account feature) | true
